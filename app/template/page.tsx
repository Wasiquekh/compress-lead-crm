                ...
                <table className="w-full text-sm text-left text-white whitespace-nowrap">
                  ...
                  <tbody>
                    {!data || data.length === 0 || isError ? (
                      <tr>
                        <td colSpan={2} className="text-center py-6 text-secondBlack ">
                          Data not found
                        </td>
                      </tr>
                    ) : (
                      data.map((item: any, index: number) => (
                        ...
                        >
                          ...
                          <td className="px-1 md:p-3 py-2">
                            <p className=" text-sm sm:text-base leading-normal truncate capitalize">
                              {item?.title ?? "-"}
                            </p>
                          </td>
        ...
        {addFrom && (
          <div className="w-full min-h-auto  p-4 text-white">
            ...
            <div className="flex justify-between mb-4 sm:mb-6 md:mb-8">
              ...
              <IoCloseOutline
                onClick={() => closeFlyout()}
                className="h-7 sm:h-8 w-7 sm:w-8 border border-gray-700 text-black rounded cursor-pointer"
              />
            </div>
                  ...
                  <div className="w-full space-y-5">
                    ...
                    <div className="w-full">
                      ...
                      <input
                        ...
                        className="w-full h-[50px] border rounded-[4px] text-secondBlack placeholder-gray-400 pl-4 mb-2 "
                      />
                    ...
                    <div className="w-full">
                      ...
                      <input
                        ...
                        className="w-full h-[50px] border rounded-[4px] text-secondBlack placeholder-gray-400 pl-4 mb-2  file:mr-4 file:py-2 file:px-4 file:rounded-[4px] file:border-0 file:text-sm file:font-semibold file:bg-primary-700 file:text-white hover:file:bg-primary-800 pt-[6px]"
                      />
                    ...
                    <div className="w-full">
                      ...
                      <textarea
                        ...
                        className="w-full border rounded-[4px] text-secondBlack placeholder-gray-400 pl-4 mb-2  pt-2"
                      />
  ...
  {({
    ...
    <Form onSubmit={handleSubmit}>
      <div className="w-full space-y-5">
        ...
        {/* Title */}
        <div className="w-full  text-secondBlack">
          ...
          <input
            ...
            onChange={handleChange}
            placeholder="Enter title"
            className="hover:shadow-hoverInputShadow focus:border-primary-600 w-full h-[50px] border border-gray-700 rounded-[4px]  placeholder-gray-400 pl-4 mb-2 "
          />
          {touched.title && errors.title && (
        ...
        {/* Subject */}
        <div className="w-full">
          <p className=" font-medium text-base leading-6 mb-2 text-secondBlack">
            Subject
          </p>
          <input
            type="text"
            ...
            onChange={handleChange}
            placeholder="Enter subject"
            className="hover:shadow-hoverInputShadow focus:border-primary-600 w-full h-[50px] border border-gray-700 rounded-[4px] text-secondBlack placeholder-gray-400 pl-4 mb-2 "
          />
          {touched.subject && errors.subject && (
        ...
        <div className="w-full">
          ...
          <input
            ...
            className="hover:shadow-hoverInputShadow focus:border-primary-600 w-full h-[50px] border border-gray-700 rounded-[4px] text-secondBlack placeholder-gray-400 pl-4 mb-2  file:mr-4 file:py-2 file:px-4 file:rounded-[4px] file:border-0 file:text-sm file:font-semibold file:bg-primary-700 file:text-white hover:file:bg-primary-800 pt-[6px]"
          />
        ...
        <div className="w-full">
          ...
          <textarea
            ...
            className="hover:shadow-hoverInputShadow focus:border-primary-600 w-full border border-gray-700 rounded-[4px] text-secondBlack placeholder-gray-400 pl-4 mb-2  pt-2"
          />
          {touched.body && errors.body && (
