...
export default function Home() {
                    ...
                    <div className="w-full flex flex-col md:flex-row gap-6">
                      ...
                      <div className="w-full relative mb-3">
                        ...
                        <PhoneInput
                          ...
                          inputClass="w-full h-[50px] text-white placeholder-gray-400 !bg-white border border-primary-100 rounded-[4px] pl-4"
                        />
                        <ErrorMessage
                          name="mobile_number"
                          component="div"
                    ...
                    <div className="w-full flex flex-col md:flex-row gap-6">
                      <div className="w-full relative mb-3">
                        ...
                        <Field
                          ...
                          className="hover:shadow-hoverInputShadow focus:border-primary-600 w-full h-[50px] border border-primary-100 rounded-[4px] text-secondBlack outline-none placeholder-gray-400 pl-4 mb-2"
                        />
                        <ErrorMessage
                          name="email"
                          component="div"
  ...
  <Select
    ...
    classNames={{
      control: ({ isFocused }) =>
        `!w-full !border-[0.4px] !rounded-[4px] !text-sm !leading-4 !font-medium !py-1.5 !px-1 !text-secondBlack !bg-white !shadow-sm ${
          isFocused
            ? "!border-primary-600"
            : "!border-gray-700"
        }`,
      singleValue: () => "!text-secondBlack !bg-white", // selected text
      input: () => "!text-secondBlack !bg-white", // typed text
      placeholder: () => "!text-gray-400 !bg-white", // placeholder text
      menu: () => "!bg-white", // dropdown menu
      menuList: () => "!bg-white", // dropdown list
      indicatorSeparator: () => "!bg-gray-300", // separator line
      dropdownIndicator: () => "!text-gray-500", // dropdown arrow
      clearIndicator: () => "!text-gray-500", // clear icon
    }}
    styles={{
      control: (base) => ({
        ...base,
      ...
      option: (base, { isFocused, isSelected }) => ({
        ...
        backgroundColor: isSelected
          ...
          : "#ffffff", // default bg - changed to white
        color: isSelected
          ? "#ffffff" // selected text
          : isFocused
          ? "#000000" // hovered text
          : "var(--secondBlack)", // default text - changed to secondBlack
        cursor: "pointer",
        "&:active": {
