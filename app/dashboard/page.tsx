      ...
      <div className=" text-white">
        ...
        <div className="ml-[97px] w-full md:w-[90%] m-auto p-4 mt-0">
          ...
          {searcheddata?.length > 0 && !isError ? (
            <>
              <table className="w-full text-sm text-left text-secondBlack  mt-6">
                ...
                <tbody>
                  {searcheddata.map((item: any, index: number) => (
                    <tr
                      key={item?.id ?? index}
                      className=" r  hover:bg-primary-100 odd:bg-primary-50 border-b border-[#E7E7E7]"
                    >
                      {/* Full name */}
                      <td
          ...
          {userRole === "Agent" && (
            <>
              ...
              <h1 className="mt-5 text-secondBlack">Table Task for Today</h1>
              <div className="overflow-x-auto rounded-lg shadow  mt-2">
                <table className="min-w-full text-sm text-left">
                  <thead className="text-secondBlack font-semibold">
                    <tr>
                  ...
                  <tbody className="">
                    {todayTasksListData.length > 0 ? (
                      todayTasksListData.map((task) => (
                        <tr
                          key={task.id}
                          className="border-t odd:bg-primary-50 hover:bg-primary-100 text-secondBlack"
                        >
                          <td
                      ...
                      <tr>
                        <td className="p-3 text-center text-secondBlack" colSpan={6}>
                          No tasks for today
                        </td>
                      </tr>
                    )}
              ...
              <h1 className="mt-5 text-secondBlack">Table Overdue Task</h1>
                  ...
                  <tbody className="">
                    {overdueTaskData.length > 0 ? (
                      overdueTaskData.map((task) => (
                        <tr
                          key={task.id}
                          className="border-t hover:bg-primary-100 odd:bg-primary-50 text-secondBlack"
                        >
                          <td
                            onClick={() => test(task.lead_id)}
