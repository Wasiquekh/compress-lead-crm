...
const LeftSideBar: React.FC = () => {
  ...
  return (
    <div
      ...
      className={`hidden  md:flex flex-col justify-between py-4 px-1 border-r-2 border-customBorder shadow-borderShadow mt-0 h-screen fixed top-0 left-0 transition-all duration-200 ease-in-out overflow-hidden text-black z-[1000] bg-white ${
    ...
    >
      ...
      <div className="z-50 custom-scrollbar">
        <Link href="/dashboard">
          <div className="flex items-center gap-4 mb-12 px-3 py-2">
            ...
            {isExpanded && (
              <p className="text-xl leading-none font-bold uppercase text-black whitespace-nowrap">
                COMPRESS CRM
              </p>
            )}
          </div>
        ...
        <Link href="/dashboard">
          <div
            className={`mb-4 flex items-center gap-4 group px-3 py-2 rounded-[4px] relative cursor-pointer text-base leading-normal font-medium text-black hover:bg-primary-600 hover:text-white active:bg-primary-700   ${
              pathname === "/dashboard"
      ...
      >
        ...
        {isExpanded && (
          <span className="text-base font-semibold leading-none text-black whitespace-nowrap">
            Logout
          </span>
        )}
      </div>
