...
>
  ...
  <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 text-secondBlack">
    {/* Full Name */}
    <div>
    ...
    {/* Best Time to Call */}
    <div>
      <p className="mb-2">Best Time to Call</p>
      <Field
        type="text"
    ...
    {/* Lead Source */}
    <div>
      <p className="mb-2">Lead Source</p>
      <CustomSelect
    ...
    {/* Assign to Agent */}
    <div>
      <p className="mb-2">Assign to Agent</p>
      <CustomSelect
    ...
    <div>
      <p className="mb-2">Debt Consolidation Status</p>
      <CustomSelect
    ...
    <div>
      <p className="mb-2">Consolidated Credit Status</p>
      <CustomSelect
