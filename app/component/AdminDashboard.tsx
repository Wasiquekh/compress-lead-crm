...
const AdminDashboard: React.FC = () => {
  ...
  return (
    <div className="container my-4 text-white ">
      <h3 className="text-2xl font-semibold mb-4 text-secondBlack">Admin Dashboard</h3>
      ...
      {/* Team Tasks by Agent */}
      <div className="mt-8">
        <h4 className="text-xl font-semibold text-secondBlack">Team Tasks by Agent</h4>
        <div className="mt-4 overflow-x-auto rounded-lg border border-gray-800">
          <table className="min-w-full table-auto text-secondBlack">
            <thead>
              <tr className="">
            ...
            <tbody>
              ...
              {teamTasksByAgent.map((agent) => (
                <tr key={agent.agent_id} className="hover:bg-primary-100 odd:bg-primary-50">
      ...
      <div className="mt-6">
        <h4 className="text-xl font-semibold text-secondBlack">Today Tasks by Agent</h4>
        <div className="mt-4">
          ...
          {todayTasksByAgent.map((agent) => {
            ...
            return (
              <div key={`today-${agent.agent_id}`} className="mb-3 overflow-hidden rounded-lg border border-gray-700">
                <button
                  className="w-full flex justify-between items-center  hover:bg-primary-100 px-4 py-3 text-left text-secondBlack font-medium"
                ...
                {isOpen && (
                  <div className=" p-4">
                    <div className="overflow-x-auto">
                      <table className="min-w-full text-sm text-secondBlack">
                        <thead>
                        ...
                        <tbody>
                          ...
                          {tasks.map((task, idx) => (
                            <tr key={`${agent.agent_id}-today-${task.lead_id}-${idx}`} className="hover:bg-primary-100 transition-colors duration-150 odd:bg-primary-50">
                              <td
      ...
      <div className="mt-6">
        <h4 className="text-xl font-semibold text-secondBlack">Overdue Tasks by Agent</h4>
        <div className="mt-4">
          ...
          {overdueTasksByAgent.map((agent) => {
            ...
            return (
              <div key={`overdue-${agent.agent_id}`} className="mb-3 overflow-hidden rounded-lg border border-gray-700">
                <button
                  className="w-full flex justify-between items-center  hover:bg-primary-500 px-4 py-3 text-left text-secondBlack   font-medium"
                    ...
                    <div className="overflow-x-auto">
                      <table className="min-w-full text-sm text-secondBlack">
                        ...
                        <tbody>
                          ...
                          {tasks.map((task, idx) => (
                            <tr key={`${agent.agent_id}-overdue-${task.lead_id}-${idx}`} className="hover:bg-primary-100 transition-colors duration-150 odd:bg-primary-50">
                              <td
                                onClick={() => openLead(task.lead_id)}
                                className="px-4 py-2 border-b border-gray-800 text-primary-600 underline  cursor-pointer rounded-l"
                                title="Open lead in new tab"
