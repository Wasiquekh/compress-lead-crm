...
const SearchLead: React.FC<SearchLeadProps> = ({
  ...
  <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
    {/* Full Name */}
    <div>
      <p className="text-secondBlack mb-2">Full Name</p>
      <Field
        type="text"
        name="full_name"
        placeholder="Alexandre Dumas"
        className="w-full border border-gray-700 rounded-[4px] bg-white text-secondBlack text-sm px-4 py-3"
      />
    </div>

    {/* Email */}
    <div>
      <p className="text-secondBlack mb-2">Email</p>
      <Field
        type="email"
        name="email"
    ...
    {/* Phone */}
    <div>
      <p className="text-secondBlack mb-2">Phone</p>
      <Field
        type="text"
        name="phone"
    ...
    {/* WhatsApp */}
    <div>
      <p className="text-secondBlack mb-2">WhatsApp Number</p>
      <Field
        type="text"
    ...
    {/* Province / State */}
    <div>
      <p className="text-secondBlack mb-2">Province</p>
      <CustomSelect
        value={values.state || ""}
    ...
    {/* Lead Source */}
    <div>
      <p className="text-secondBlack mb-2">Lead Source</p>
      <CustomSelect
    ...
    {/* Agents (MULTI) */}
    <div>
      <p className="text-secondBlack mb-2">Agents</p>
      {/* NOTE: CustomSelect does not support multi-select, so keeping original Select for multi */}
      <Select
        isMulti
        ...
        styles={{
          menu: (base) => ({ ...base, borderRadius: 4, backgroundColor: "#fff" }),
          option: (base, { isFocused, isSelected }) => ({
            ...base,
            backgroundColor: isSelected ? "var(--primary-600)" : isFocused ? "#e5e7eb" : "#fff",
    ...
    <div>
      <p className="text-secondBlack mb-2">Debt Consolidation Status</p>
      <CustomSelect
    ...
    <div>
      <p className="text-secondBlack mb-2">Consolidated Credit Status</p>
      <CustomSelect
