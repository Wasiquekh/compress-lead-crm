...
const unBlockUserData = async(id: string)=>{
 ...
 <div className="relative overflow-x-auto sm:rounded-lg">
  <table className="w-full text-sm text-left text-secondBlack">
    <thead className="text-xs ">
      <tr className="  ">
        <th className="px-1 p-3 md:p-3    font-semibold  text-base">
        ...
        <th className="px-2 py-1   ">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold  text-sm sm:text-base">Action</span>
          </div>
        </th>
      </tr>
    </thead>
    ...
    <tbody>
      {!data || data.length === 0 || isError ? (
        <tr>
          <td colSpan={4} className="text-center text-xl py-6 text-textGrey">
            Data not found
          </td>
        </tr>
      ) : (
        data.map((item: any, index: number) => (
          ...
          >
            <td className="px-1 md:p-3 py-2 flex md:flex-row gap-2">
              <p className=" text-sm sm:text-base font-medium leading-normal capitalize truncate">
                {item?.name ?? "-"}
              </p>
            </td>
            <td className="px-2 py-1    hidden md:table-cell">
              <p className=" text-sm sm:text-base font-medium leading-normal truncate">
                {item?.email ?? "-"}
              </p>
            </td>
            <td className="px-2 py-1    hidden md:table-cell">
            ...
            <td className="px-2 py-1   ">
              <div className="flex gap-1 md:gap-2 justify-center md:justify-start">
                ...
                >
                  ...
                  <p className=" hidden md:block text-white">Unblock user</p>
                </button>
              </div>
            </td>
          </tr>
          ...
          {/* ----------------End table--------------------------- */}
          {/* Pagination Controls */}
 <div className="flex justify-center items-center my-10 relative text-secondBlack">
  <button
