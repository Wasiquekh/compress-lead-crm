...
export default function LoginHome() {
  ...
  return (
    <>
      ...
      <div className="absolute top-0 bottom-0 left-0 right-0 mx-auto my-auto w-[90%] max-w-[500px] h-[587px] shadow-loginBoxShadow  px-6 sm:px-12 py-10 sm:py-16 rounded-lg bg-white">
        <Image
          src="/images/compressIcon.svg"
          alt="OrizonIcon"
          width={82}
              ...
              <div className="w-full">
                ...
                <div className="relative">
                  <Field
                    ...
                    className="focus:outline-none w-full h-[50px] border border-[#DFEAF2] rounded-[4px] text-[15px]  pl-4 mb-7 hover:shadow-hoverInputShadow focus:border-primary-500 "
                  />
                  <ErrorMessage
                    name="email"
                    component="div"
                ...
                <div className="relative">
                  <Field
                    ...
                    className="focus:outline-none w-full h-[50px] border border-[#DFEAF2] rounded-[4px] text-[15px] pl-4 mb-8  hover:shadow-hoverInputShadow focus:border-primary-500 "
                  />
                  {showPassword ? (
                    <FaRegEye
